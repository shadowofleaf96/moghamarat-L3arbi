...
namespace RedRunner
{
    ...
    public class AudioManager : MonoBehaviour
    {
		...
		[SerializeField]
        protected AudioClip m_InGameMusic;
        ...
        [SerializeField]
		protected AudioClip m_Wahyaliyamwah;
        [SerializeField]
		...
		public void PlayAlternativeMusic()
        {
		...
		public void StopAlternativeMusic()
        {
            m_MusicAudioSource.clip = m_InGameMusic;
            m_MusicAudioSource.Stop();
        }
		...
		public void PauseAlternativeMusic()
        {
            m_MusicAudioSource.clip = m_InGameMusic;
            m_MusicAudioSource.Pause();
        }
        ...
        public void PlayCoinSound(Vector3 position)
        {
		  ...
		  public void PlayWahSound(Vector3 position)
        {
            PlaySoundOn(m_SoundAudioSource, m_Wahyaliyamwah);
        }
        ...
        {
            PlaySoundOn(m_SoundAudioSource, m_Die);
        }
